...
###########################################
def main(predator_breed_time=6, predator_starve_time=5, initial_predators=8, prey_breed_time=2, initial_prey=60, \
         human_starve_time = 5, human_breed_time = 6, initial_humans = 8, size=10, ticks=1000):
